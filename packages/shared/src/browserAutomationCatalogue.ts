...
const BROWSER_COMMON_AGENT_GUIDANCE =
  "Controls only Quack's visible shared WebView (same DOM, cookies and session), never chat or desktop; no approval prompt is required.";
