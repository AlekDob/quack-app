...
// Stable phrase embedded in the server's "thread is already archived" orchestration
// invariant message. Shared so a client retry after a committed-but-unacked archive
// (timeout, dropped shell push, double-click) can treat the race as success and
// still hide the thread locally.
export const THREAD_ALREADY_ARCHIVED_INVARIANT_MARKER = "is already archived";
