...
// the shareable activity card. All metrics are backed by Quack's local DB
...
export const ProfileActivity = Schema.Struct({
  ...
  // totalPromptsSent), i.e. days the user actually used Quack.
...
// Token totals come from Quack's projected context-window updates. `available`
