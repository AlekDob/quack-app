...
// Format tokens as K or M (e.g., 55500 -> "55.5k", 1000000 -> "1.0M")
      ...
      <div className="token-modal fallout-style context-receipt" onClick={(e) => e.stopPropagation()}>
        ...
        <div className="token-modal-content fallout-content">
          ...
          <div className="token-info">
            ...
            <span>Claude sessions have a {maxTokens >= 1_000_000 ? '1M' : '200k'} token context window. Use /compact to preserve context while reducing tokens.</span>
          </div>
        </div>
      </div>
    </div>
