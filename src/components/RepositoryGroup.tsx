      ...
      >
        <div className="flex w-full flex-col gap-1">
          <div className="flex items-center gap-2">
            ...
            {onCreateAgent && (
              <button
                ...
                onClick={(e) => {
                  e.stopPropagation();
                  onCreateAgent(repoPath);
                }}
                title="Add a new agent to this project"
                className="repo-new-agent-btn"
              >
          ...
          >
            ...
            <KeyboardShortcutTooltip label="Finder">
            <button
              type="button"
              onClick={async () => {
                try {
            ...
            {onRemoveProject && (
              <KeyboardShortcutTooltip label="Remove">
              <button
                type="button"
                ...
                return Array.from(worktreeByBranch.entries()).map(
                  ([branchName, agents]) => (
                    ...
                    >
                      ...
                      {/* Worktree Agents */}
                      {/* Brain: fix-worktree-hooks-violation — extracted to WorktreeAgentCard */}
                      {agents.map((agent) => (
                        <WorktreeAgentCard
                          key={agent.id}
                          agent={agent}
                          ...
                          chatSessions={chatSessions}
                          allSessionsForRepo={allSessionsForRepo}
                          chatLoadingMap={chatLoadingMap}
                          lastReadTimestamps={lastReadTimestamps}
                          isKanbanViewActive={isKanbanViewActive}
