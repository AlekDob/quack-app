// Pinky Brain panel — hybrid search, setup, and workspace brain health.
// Opens as an editor tab (brain:<wsId>) like Usage / Whiteboard.
    ...
    return (
      <div className="brain-panel">
        <div className="brain-panel-inner">
          <p className="brain-muted">Loading Pinky Brain…</p>
        </div>
      </div>
    );
  }
      ...
      <div className="brain-panel">
        <div className="brain-panel-inner">
          ...
          <p className="brain-muted">
            Install the Pinky CLI to enable hybrid knowledge search.
          </p>
          <a
            className="brain-link"
            href="https://pinkybrain.dev"
            target="_blank"
            rel="noreferrer"
          >
            pinkybrain.dev
