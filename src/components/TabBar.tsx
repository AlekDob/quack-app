...
export interface Tab {
  id: string;
  label: string;
  type: 'chat' | 'file' | 'agent-terminal' | 'agent' | 'browser' | 'skill' | 'command' | 'rule' | 'docs' | 'memory-graph' | 'second-brain' | 'claude-assets' | 'kanban' | 'task' | 'project-dashboard' | 'image' | 'teammate-stream' | 'automation' | 'office' | 'code-editor' | 'feature-map';
  closable: boolean;
  filePath?: string;
