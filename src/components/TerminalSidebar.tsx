      ...
      <div className="sidebar-header-top" data-tauri-drag-region>
        ...
        {onTogglePip && (
          <KeyboardShortcutTooltip label={isPipOpen ? "Close PiP" : "PiP"}>
            ...
            >
              <svg width="10" height="10" viewBox="0 0 16 16" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" style={{ display: 'block' }}>
                <rect x="1" y="2" width="14" height="10" rx="1.5" />
                <rect x="8" y="6" width="5.5" height="4.5" rx="1" fill="currentColor" stroke="none" />
              </svg>
            </button>
          </KeyboardShortcutTooltip>
        )}
