...
const TodoWidget: React.FC<TodoWidgetProps> = ({ todos, defaultExpanded = true, isStale = false }) => {
      ...
      case 'completed':
        return (
          <div className="todo-status-icon-wrapper completed">
            <svg className="todo-status-icon completed" width="14" height="14" viewBox="0 0 24 24" fill="none">
      ...
      case 'in_progress':
        return (
          <div className="todo-status-icon-wrapper in-progress">
            <svg className="todo-status-icon in-progress" width="14" height="14" viewBox="0 0 24 24" fill="none">
              <circle cx="12" cy="12" r="10" stroke="#3b82f6" strokeWidth="2" fill="none" strokeDasharray="63" strokeDashoffset="16" className="rotating-circle"/>
      ...
      case 'pending':
        return (
          <div className="todo-status-icon-wrapper pending">
            <svg className="todo-status-icon pending" width="14" height="14" viewBox="0 0 24 24" fill="none">
  ...
  const getToolIcon = () => {
    return (
      <svg width="12" height="12" viewBox="0 0 16 16" fill="currentColor" className="todo-tool-icon">
