...
| Component   | `apps/web/src/components/chat/ChatStreamIdentity.tsx`                                                                                                                                            | Shared transcript identity: `RoundAvatarImage`, `ChatStreamAvatarSlot`, `ChatStreamMetaRow` (label · model · effort flex row) — used by paperi and [005-subagent-avatars.md](005-subagent-avatars.md); `ChatStreamAvatarSlot` sticky-tracks scroll for the turn's duration, see sticky-scroll behavior in [005-subagent-avatars.md](005-subagent-avatars.md)                                                               |
