...
tags: [edit-summary-bar, file-edits, per-turn, chat-view]
---
...
| Component | src/components/EditSummaryBar.tsx | Inline bar rendering file changes (no changes — just receives different props now) |
