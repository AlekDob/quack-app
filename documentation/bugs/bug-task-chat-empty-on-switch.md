...
type: bug
created: 2026-01-10
tags: [react, state-management, batching, async]
---

# bug-task-chat-empty-on-switch

DEFINITIVO: Risolto bug ricorrente dove i messaggi chat non apparivano quando si switchava tra task
...
ensureListenerReady ora e' fire-and-forget con .then()/.catch() - non blocca piu' il render
