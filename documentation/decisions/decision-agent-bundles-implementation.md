...
type: decision
created: 2026-01-10
tags: [agent-bundles, implementation, ui, cyberpunk]
---

# Quack Agent Bundles Implementation
...
- Simple Power Rating formula: 100 + (Skills x 100) + (Droids x 150) + (Rules x 50) + (Commands x 75)
