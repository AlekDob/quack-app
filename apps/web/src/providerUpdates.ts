...
// A provider whose latest version Quack cannot look up (self-updating CLIs such as
...
// Header affordance: reserved for providers Quack can actually assert are outdated.
