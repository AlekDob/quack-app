 ...
 * names. Because the migrator skips by ID, Quack migrations 17-31 never run
 ...
 * Quack migrations known at the time, but predecessor trackers eventually
 ...
 *
 * Idempotent and a no-op for fresh Quack installs (every column already
