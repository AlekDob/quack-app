...
// Purpose: Bridges ACP form elicitation schemas to Quack's provider-neutral question UI.
...
// Converts primitive ACP form fields into the question shape consumed by Quack's composer.
