...
export interface AcpSessionRuntimeOptions {
   ...
   * `mcpCapabilities` (e.g. HTTP vs stdio for the Quack agent gateway).
   */
...
/**
 * Bridges Effect's child-process exit signal into Quack's process-tree proof. This is deliberately
