...
Il pattern è **identico** a `AskUserQuestion`:
...
3. Quando mostra il piano, verifica che:
   ...
   - L'esecuzione NON parte finché non clicchi Approve
...
- Quack Brain: `~/.quack/brain/projects/quack-app/patterns/ai-chat-system.md`
