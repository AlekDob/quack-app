...
Based on the project type ({{TECH_STACK}}), I coordinate with Scott to recruit the right specialists:
...
│   ├── {{PROJECT_NAME}}-development/  # Main project folder
│   │   └── summary.md
