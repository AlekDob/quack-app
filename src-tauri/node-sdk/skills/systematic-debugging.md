...
1.5. **Check Quack Brain**
   - CLAUDE.md Knowledge Base lists known bugs and gotchas with file paths — read relevant ones
   - Search `documentation/bugs/` and `documentation/gotchas/` with Grep for related keywords
   - If a Brain entry exists for this issue, the root cause is already documented — follow it
...
5. **Trace Data Flow (Root Cause Tracing)**
   ...
   **WHEN error is deep in call stack:**
   ...
   - Use `new Error().stack` to capture complete call chains
