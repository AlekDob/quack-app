...
- `documentation/features/` — map of the product's durable parts (one doc per component).
  ...
  - `085-agent-ide-mode-toggle.md` — Agents ↔ IDE layout toggle (`lcp.agentMode`): full shell swap; cold cost = chat disk hydrate + terminal reattach; warm path keeps rich RAM transcript; `[agent-mode-switch]` timings.
