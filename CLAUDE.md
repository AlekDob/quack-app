...
- `documentation/features/` — map of the product's durable parts (one doc per component).
  ...
  - `088-plan-milo-handoff.md` — Cursor-style **Pass the ball to Milo** after ExitPlanMode: in-stream CTA, Features-first, Milo + Agent + auto-send; Keep discussing / composer send = stay Plan.
